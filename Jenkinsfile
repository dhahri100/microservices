pipeline {
    ...
    environment {
        ...
        SONAR_PROJECT_KEY = "microservices-emailservice"  // Specify your project key here
        SONAR_PROJECT_NAME = "Email Service"  // Optional: Give your project a name
        SONAR_PROJECT_VERSION = "1.0"
        APP_NAME = "emailservice"  // The name of the image (emailservice)
        RELEASE = "1.0.0"
            ...
            steps {
                script {
                    ...
                    sh '''
                        ...
                        -Dsonar.projectName="email Service" \
